...
export function createTopBar(activePage, data) {
  ...
  return [
    ...
    `<h1 class="page-title">${escapeHtml(rangeLabel)}</h1>`,
    '</div>',
    '<div class="topbar-actions">',
    renderSyncChip(),
    `<a class="icon-button${activePage === 'settings' ? ' is-active' : ''}" href="settings.html" aria-label="Mở trang thiết lập">${renderIcon('settings', { size: 18 })}</a>`,
